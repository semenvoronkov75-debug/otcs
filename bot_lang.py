...
<blockquote><i><tg-emoji emoji-id="5456140674028019486">⚡️</tg-emoji> Ваш надёжный P2P-гарант:</i>
	...
	<tg-emoji emoji-id="5793901252987330401">4⃣</tg-emoji> <tg-emoji emoji-id="5778672437122045013">📦</tg-emoji> Передача товаров через менеджера: @PlayerokOTC_Manager</blockquote>
...
Продавец отправит товар @PlayerokOTC_Manager, после проверки вы получите уведомление.""",
...
Товар должен быть передан исключительно поддержке - @PlayerokOTC_Manager!
...
Произошла ошибка при обработке вашего запроса на вывод. Пожалуйста, свяжитесь с техподдержкой: @PlayerokOTC_Manager""",
...
\t<tg-emoji emoji-id="5793901252987330401">4⃣</tg-emoji> <tg-emoji emoji-id="5778672437122045013">📦</tg-emoji> All items go through our manager: @PlayerokOTC_Manager</blockquote>
...
The seller transfers the item to @PlayerokOTC_Manager and you'll be notified once we verify it.""",
...
Transfer the item ONLY to @PlayerokOTC_Manager. Never directly to the buyer.
...
Something went wrong while processing your item claim. Please reach out to support: @PlayerokOTC_Manager""",
        'balance_withdrawal_error': """⚠️ <b>Couldn't process the withdrawal</b>

Something went wrong while processing your withdrawal. Please reach out to support: @PlayerokOTC_Manager""",
