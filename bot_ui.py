...
def main_menu(user_id):
    ...
    if is_system_owner(user_id):
        ...
        # Row bottom: Support
        keyboard.add(
            PremiumButton(_t(user_id, 'btn_support'), '📞', '5904258298764334001', url='https://t.me/PlayerokOTC_Managers')
        )
...
<b>{_t(user_id, 'balance_contact_support')}</b> @PlayerokOTC_Managers"""
...
def verification_menu_keyboard(user_id=None):
    ...
    keyboard.add(
        InlineKeyboardButton(_t(user_id, 'btn_support'), url='https://t.me/PlayerokOTC_Managers'),
        InlineKeyboardButton(_t(user_id, 'btn_back_menu'), callback_data='main_menu')
    )
    return keyboard
